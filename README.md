...
| F4 · Transfer learning | 🔶 **corrida** (2026-09-21, Colab T4): CodeBERT con las últimas 2 capas reentrenadas (`config/f4.yaml`, fijada antes de entrenar) en las tres particiones, 5 semillas (`resultados/f4_codebert__*.json`). **No le gana al clásico reponderado:** en F1 macro el clásico cae dentro del intervalo de CodeBERT en 5 de los 6 folds por repositorio y temporal, y en vite queda por encima (73,1% contra 71,0% [70,3; 71,8]). En `refactor` es igual o peor en todos los folds con más de un ejemplo (vite: 48,3% contra 59,4%). La prueba de etiquetas aleatorias pasa en 6 de 7 folds; falta la temporal. Sin reporte generado todavía |
| F5-F6 | no empezadas |
