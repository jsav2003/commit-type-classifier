...
| F5 · Red desde cero | 🔶 **en curso** (2026-09-22): `config/f5.yaml` fijada antes de entrenar — la arquitectura de CodeBERT con pesos al azar, entrenada entera, con los hiperparámetros de la F4 (DESIGN.md §6.4). Probada en CPU; falta correrla en GPU (`docs/KAGGLE_F5.md`; Colab cortó la GPU gratuita por uso, `docs/COLAB_F5.md` queda como alternativa) |
| F6 | no empezada |
